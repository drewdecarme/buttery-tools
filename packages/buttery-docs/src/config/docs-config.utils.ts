...
export type ButteryDocsConfigHeaderLinkTypeSocial = {
  type: "social";
...
export type ButteryDocsConfigHeaderLinkTypeText = {
  type: "text";
  text: string;
  href: string;
};
export type ButteryDocsConfigHeaderLinkTypeInternal = {
  type: "internal";
  text: string;
  href: string;
};
export type ButteryDocsConfigHeaderLinkTypeDropdown = {
  type: "dropdown";
  text: string;
  items: (Omit<ButteryDocsConfigHeaderLinkTypeInternal, "type"> & {
    subText?: string;
    iconSrc: string;
    iconAlt: string;
  })[];
};
export type ButteryDocsConfigHeaderLink =
  | ButteryDocsConfigHeaderLinkTypeSocial
  | ButteryDocsConfigHeaderLinkTypeText
  | ButteryDocsConfigHeaderLinkTypeInternal
  | ButteryDocsConfigHeaderLinkTypeDropdown;

export type ButteryDocsConfigOrder = {
  [pageName: string]: string[];
};
export type ButteryDocsConfigHeader = {
  /**
...
export type ButteryDocsConfig = {
   ...
   * ```
   */
  order?: ButteryDocsConfigOrder;
  header?: ButteryDocsConfigHeader;
  vitePlugins?: ((params: unknown) => Plugin[]) | Plugin[];
};

export const butteryDocsConfigDefaults: ButteryDocsConfig = {
