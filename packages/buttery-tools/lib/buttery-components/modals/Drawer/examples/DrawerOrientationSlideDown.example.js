...
export default () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: openDrawer, children: "Slide down" }), _jsx(Drawer, { ref: drawerRef, dxOrientation: "slide-down", className: drawerStyles, children: "This is some drawer content!" })] }));
};
