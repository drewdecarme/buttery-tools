...
export default () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: openDrawer, children: "Slide Right" }), _jsx(Drawer, { ref: drawerRef, dxOrientation: "slide-right", className: drawerStyles, children: "This is some drawer content!" })] }));
};
