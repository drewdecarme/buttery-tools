...
export default () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: openDrawer, children: "Open Drawer" }), _jsx(Drawer, { ref: drawerRef, dxOrientation: "slide-left", className: drawerStyles, children: "This is some drawer content!" })] }));
};
