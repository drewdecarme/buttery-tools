...
export default function ModalBase() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", onClick: openModal, children: "Open Modal" }), _jsx(Modal, { ref: modalRef, className: styles, children: "This is a basic modal" })] }));
}
