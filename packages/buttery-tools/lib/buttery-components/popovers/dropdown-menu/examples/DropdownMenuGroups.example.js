...
export default () => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("button", { type: "button", ...targetProps, children: "Toggle Context Menu" }), _jsxs(DropdownMenu, { ...dropdownProps, className: menuClassName, children: [_jsxs("ul", { children: [_jsx("li", { children: _jsx("button", { type: "button", children: "Reply" }) }), _jsx("li", { children: _jsx("button", { type: "button", children: "Reply All" }) }), _jsx("li", { children: _jsx("button", { type: "button", children: "Forward" }) })] }), _jsxs("ul", { children: [_jsx("li", { children: _jsx("button", { type: "button", children: "Print" }) }), _jsx("li", { children: _jsx("button", { type: "button", children: "Delete" }) }), _jsx("li", { children: _jsx("button", { type: "button", children: "Archive" }) })] })] })] }));
};
