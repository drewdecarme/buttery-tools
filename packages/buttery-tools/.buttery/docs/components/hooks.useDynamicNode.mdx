...
{/* fence:"artifacts/buttery-components/hooks/useDynamicNode/examples/UseDynamicNode.example.tsx" */}
...
{/* example:"artifacts/buttery-components/hooks/useDynamicNode/examples/UseDynamicNode.example.tsx" */}
