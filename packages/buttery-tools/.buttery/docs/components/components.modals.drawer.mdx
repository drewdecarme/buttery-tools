...
{/* fence:"/src/modals/Drawer/examples/DrawerBarebones.example.tsx" */}
...
{/* example:"/src/modals/Drawer/examples/Drawer.example.tsx" */}
...
{/* example:"/src/modals/Modal/examples/ModalBasic.example.tsx" */}
...
{/* example:"/src/modals/Drawer/examples/DrawerOrientationSlideRight.example.tsx" */}

#### Slide left

A drawer that slides from the right to the left.
{/* example:"/src/modals/Drawer/examples/DrawerOrientationSlideLeft.example.tsx" */}

#### Slide-up

A drawer that slides up from the bottom.
{/* example:"/src/modals/Drawer/examples/DrawerOrientationSlideUp.example.tsx" */}

#### Slide-down

A drawer that slides down from the top.
{/* example:"/src/modals/Drawer/examples/DrawerOrientationSlideDown.example.tsx" */}
