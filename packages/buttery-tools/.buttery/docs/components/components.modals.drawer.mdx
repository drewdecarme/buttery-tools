...
title: Drawer
meta:
  - title: Drawer | Buttery Components
  - name: description
...
{/* fence:"/lib/buttery-components/modals/Drawer/examples/DrawerBarebones.example.tsx" */}
...
{/* example:"/lib/buttery-components/modals/Drawer/examples/Drawer.example.tsx" */}
...
{/* example:"/lib/buttery-components/modals/Modal/examples/ModalBasic.example.tsx" */}
...
{/* example:"/lib/buttery-components/modals/Drawer/examples/DrawerOrientationSlideRight.example.tsx" */}

#### Slide left

A drawer that slides from the right to the left.
{/* example:"/lib/buttery-components/modals/Drawer/examples/DrawerOrientationSlideLeft.example.tsx" */}

#### Slide-up

A drawer that slides up from the bottom.
{/* example:"/lib/buttery-components/modals/Drawer/examples/DrawerOrientationSlideUp.example.tsx" */}

#### Slide-down

A drawer that slides down from the top.
{/* example:"/lib/buttery-components/modals/Drawer/examples/DrawerOrientationSlideDown.example.tsx" */}
