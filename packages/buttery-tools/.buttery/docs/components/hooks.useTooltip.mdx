...
title: useTooltip
meta:
  - title: useTooltip | Buttery Components
  - name: description
...
{/* fence:"artifacts/buttery-components/hooks/useTooltip/examples/UseTooltip.code.tsx" */}
...
{/* example:"artifacts/buttery-components/hooks/useTooltip/examples/UseTooltip.example.tsx" */}
...
{/* example:"artifacts/buttery-components/hooks/useTooltip/examples/UseTooltipToggletip.example.tsx" */}
...
{/* example:"artifacts/buttery-components/hooks/useTooltip/examples/UseTooltipWithCount.example.tsx" */}
