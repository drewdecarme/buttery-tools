...
{/* example:"artifacts/buttery-components/popovers/dropdown-menu/examples/DropdownMenu.example.tsx" */}
...
{/* example:"artifacts/buttery-components/popovers/dropdown-menu/examples/DropdownMenuBarebones.example.tsx" */}
...
{/* example:"artifacts/buttery-components/popovers/dropdown-menu/examples/DropdownMenuWithOffset.example.tsx" */}

### With Arrow

You can add an arrow between the target and the dropdown by adding a `dxArrow` option to the
`useDropdownMenu` hook.
{/* example:"artifacts/buttery-components/popovers/dropdown-menu/examples/DropdownMenuWithArrow.example.tsx" */}

### Positioning

You can position the element anywhere surrounding the target
{/* example:"artifacts/buttery-components/popovers/dropdown-menu/examples/DropdownMenuPositions.example.tsx" */}
...
{/* example:"artifacts/buttery-components/popovers/dropdown-menu/examples/DropdownMenuGroups.example.tsx" */}
