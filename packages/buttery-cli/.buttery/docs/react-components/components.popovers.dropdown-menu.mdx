---
title: DropdownMenu | Components | Buttery Tools
meta:
  - type: name
    name: description
...
{/* example:"lib/components/popovers/DropdownMenu/examples/DropdownMenu.example.tsx" */}
...
> the [DropdownNav](./components.popovers.DropdownNav.mdx) component.
...
{/* example:"lib/components/popovers/DropdownMenu/examples/DropdownMenuWithOffset.example.tsx" */}

### With Arrow

You can add an arrow between the target and the dropdown by adding a `dxArrow` option to the
`useDropdownMenu` hook.
{/* example:"lib/components/popovers/DropdownMenu/examples/DropdownMenuWithArrow.example.tsx" */}

### Positioning

You can position the element anywhere surrounding the target
{/* example:"lib/components/popovers/DropdownMenu/examples/DropdownMenuPositions.example.tsx" */}
...
{/* example:"lib/components/popovers/DropdownMenu/examples/DropdownMenuGroups.example.tsx" */}
