...
{/* fence:"lib/components/hooks/useDynamicNode/examples/UseDynamicNode.example.tsx" */}
...
{/* example:"lib/components/hooks/useDynamicNode/examples/UseDynamicNode.example.tsx" */}
