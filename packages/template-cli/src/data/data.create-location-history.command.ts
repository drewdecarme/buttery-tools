...
export const commandDataAssetLocationHistory = new Command(
  "asset-location-history"
).description(
  "Creates a user defined number of location history records for an asset"
);
...
commandDataAssetLocationHistory.action(command);
