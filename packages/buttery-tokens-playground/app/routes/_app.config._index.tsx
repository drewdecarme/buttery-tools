...
export default function ConfigColorsRoute() {
  return (
    <>
      <LayoutConfigSection>
        <LayoutConfigSectionControls dxTitle="Brand Colors">
          <LayoutConfigSectionControlsDescription>
            Brand colors are an essential part of your application&apos;s design
            system, providing consistency and harmony across all visual assets.
            <br />
            <br />
            Select one of the below modes to get started creating colors
          </LayoutConfigSectionControlsDescription>
      ...
      <LayoutConfigSection>
        <LayoutConfigSectionControls dxTitle="Neutral Colors">
          <LayoutConfigSectionControlsDescription>
            Brand colors are an essential part of your application&apos;s design
            system, providing consistency and harmony across all visual
            elements. This configuration allows you to generate a cohesive color
            palette using harmonious fluorescent tones by defining parameters
            for saturation, brightness, and hue variations.
          </LayoutConfigSectionControlsDescription>
        </LayoutConfigSectionControls>
      </LayoutConfigSection>
    </>
